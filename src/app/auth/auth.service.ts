...
export class AuthService {
  ...
  // this is a hack to get postList and header components to acknowledge login
  getIsAuth() {
  ...
  /* local functions */
   ...
   autoAuthUser() {    
    ...
    if (!authInformation) {  // this occurs on refresh and initial page load
      return;
    }
